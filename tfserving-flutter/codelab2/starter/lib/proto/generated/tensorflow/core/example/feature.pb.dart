...
class BytesList extends $pb.GeneratedMessage {
  ...
  BytesList copyWith(void Function(BytesList) updates) =>
      super.copyWith((message) => updates(message as BytesList)) as BytesList;
...
class Int64List extends $pb.GeneratedMessage {
  ...
  Int64List copyWith(void Function(Int64List) updates) =>
      super.copyWith((message) => updates(message as Int64List)) as Int64List;
...
class Feature extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<BytesList>(1, _omitFieldNames ? '' : 'bytesList',
        subBuilder: BytesList.create)
    ..aOM<FloatList>(2, _omitFieldNames ? '' : 'floatList',
        subBuilder: FloatList.create)
    ..aOM<Int64List>(3, _omitFieldNames ? '' : 'int64List',
...
class Features extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tensorflow'),
      createEmptyInstance: create)
    ..m<$core.String, Feature>(1, _omitFieldNames ? '' : 'feature',
        entryClassName: 'Features.FeatureEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: Feature.create,
        valueDefaultOrMaker: Feature.getDefault,
...
class FeatureList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FeatureList',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tensorflow'),
      createEmptyInstance: create)
    ..pc<Feature>(1, _omitFieldNames ? '' : 'feature', $pb.PbFieldType.PM,
...
class FeatureLists extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FeatureLists',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tensorflow'),
      createEmptyInstance: create)
    ..m<$core.String, FeatureList>(1, _omitFieldNames ? '' : 'featureList',
        entryClassName: 'FeatureLists.FeatureListEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: FeatureList.create,
        valueDefaultOrMaker: FeatureList.getDefault,
        packageName: const $pb.PackageName('tensorflow'))
    ..hasRequiredFields = false;
