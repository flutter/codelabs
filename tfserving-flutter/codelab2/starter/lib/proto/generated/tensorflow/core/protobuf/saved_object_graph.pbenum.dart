...
class FunctionSpec_JitCompile extends $pb.ProtobufEnum {
  static const FunctionSpec_JitCompile DEFAULT = FunctionSpec_JitCompile._(0, _omitEnumNames ? '' : 'DEFAULT');
  static const FunctionSpec_JitCompile ON = FunctionSpec_JitCompile._(1, _omitEnumNames ? '' : 'ON');
  static const FunctionSpec_JitCompile OFF = FunctionSpec_JitCompile._(2, _omitEnumNames ? '' : 'OFF');
