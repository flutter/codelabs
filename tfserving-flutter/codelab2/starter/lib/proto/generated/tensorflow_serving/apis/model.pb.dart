...
class ModelSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'tensorflow.serving'), createEmptyInstance: create)
    ..oo(0, [2, 4])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$0.Int64Value>(2, _omitFieldNames ? '' : 'version', subBuilder: $0.Int64Value.create)
  ...
  @$pb.TagNumber(2)
  set version($0.Int64Value v) { $_setField(2, v); }
  @$pb.TagNumber(2)
