...
class NarrowDisplayPlaylists extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const AdaptiveText('FlutterDev Playlists')),
      body: Playlists(
        playlistSelected: (Playlist playlist) {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) {
                return Scaffold(
                  appBar: AppBar(title: AdaptiveText(playlist.snippet!.title!)),
    ...
    return Scaffold(
      appBar: AppBar(
        title: selectedPlaylist == null
            ? const AdaptiveText('FlutterDev Playlists')
            : AdaptiveText(
      ...
      body: SplitView(
        ...
        children: [
          ...
          if (selectedPlaylist != null)
            ...
            const Center(
              child: AdaptiveText('Select a playlist'),
            ),
        ],
      ),
    );
